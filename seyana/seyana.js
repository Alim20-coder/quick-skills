...
const translations = {
    ar: {
        ...
        coat_internal_desc: "تطبيق الطلاء الداخلي (الإيبوكسي السائل وطلاء مسحوق FBE) للأنابيب ووصلات اللحام في خطوط الأنابيب مع مراعاة المواد المعتمدة من WRAS..",
        coat_external_title: "الطلاء الخارجي",
        coat_external_desc: "تطبيق الطلاء الخارجي بتقنية HSS والتغليف البارد مع نتائج متينة من خلال إجراءات عالية الجودة.",
    ...
    en: {
        ...
        coat_internal_desc: "Applying internal coating (Liquid Epoxy and FBE powder coating) for piping and pipeline welded joints respecting WRAS approved materials.",
        coat_external_title: "External Coating",
        coat_external_desc: "HSS and cold wrapping external coating application with durable results through high quality level procedures.",
